...
const PlansSection = () => {
  ...
  return (
    <section id="planes" ref={sectionRef} className="section-padding">
      ...
      {/* AYU Impact Section - matching ProcessSection layout */}
      <section className="section-padding bg-ayu-pink relative overflow-hidden mt-16">
        {/* Decorative elements matching ProcessSection */}
